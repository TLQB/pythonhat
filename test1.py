...
wlan_pattern = re.compile("wlx146b9c0307ef")
...
put_in_monitored_mode = subprocess.run(["sudo", "airmon-ng", "start", "wlx146b9c0307ef"])
...
try:
    while True:
        ...
        print(active_wireless_networks)
...
print(check_wifi_result[int(wifi_interface_choice)] + "mon","###################################")
